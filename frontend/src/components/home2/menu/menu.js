...
import {CarouselProvider, Image, Slide, Slider, ImageWithZoom} from "pure-react-carousel";
                ...
                >
                    <Slider>
                        ...
                        <Slide index={2} className={"menu__item"}>
                            <h5 className={"menu__title"}>Chicken Tikka Masala</h5>
                            <span className={"menu__price"}>7€</span>
                            <ImageWithZoom  src={"../../../../static/img/henrique-felix-dMFIBmDYaIQ-unsplash.jpg"}/></Slide>
                        ...
                        <Slide index={4} className={"menu__item"}>
                            <h5 className={"menu__title"}>Chicken Tikka Masala</h5>
                            <span className={"menu__price"}>7€</span>
                            <ImageWithZoom src={"../../../../static/img/michael-browning-MtqG1lWcUw0-unsplash.jpg"}/></Slide>
